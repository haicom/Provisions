...
public abstract class SQLiteContentProvider extends ContentProvider
     ...
     */
    protected abstract Uri insertInTransaction(Uri url, ContentValues initialValues);

    /**
     * The equivalent of the {@link #update} method, but invoked within a transaction.
     */
    protected abstract int updateInTransaction(Uri url, ContentValues values, String where,
            String[] whereArgs);

    /**
     * The equivalent of the {@link #delete} method, but invoked within a transaction.
     */
    protected abstract int deleteInTransaction(Uri url, String where, String[] whereArgs);
